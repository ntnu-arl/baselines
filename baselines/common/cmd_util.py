...
def common_arg_parser():
    ...
    parser.add_argument('--load_actor_dagger_path', help='Path to load actor dagger trained model from', default=None, type=str)
    parser.add_argument('--load_critic_dagger_path', help='Path to load critic dagger trained model from', default=None, type=str)
